...
public class MEM implements IMemoryAccess {
	...
	private int currentInstrIndex; // holds the index in the preMEMBuffer of the
									// current instruction
	...
	/**
	 * Class constructor the pre-MEM buffer size as a parameter as parameters
	 */
	...
	public void processClockCycle() {
		...
		if (stallCycles == 0) {
			...
			if (tmpStr == "lw") {
				double memValue = memList.get(currentInstruction.rt
