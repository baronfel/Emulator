...
public class ALU implements IALU {
 ...
 public void processClockCycle() {
  ...
  // the buffer
  if (currentInstruction.opName == "" || currentInstruction.opName == "nop" ) {
  ...
  if (stallCycles == 0) {
   ...
   switch (currentInstruction.opName) {
     case "mul":
       operationResult = mult(currentInstruction.op1Value,currentInstruction.op2Value);
       break;
     case "div":
       operationResult = div(currentInstruction.op1Value, currentInstruction.op2Value);
       break;
     case "add":
       operationResult = add(currentInstruction.op1Value, currentInstruction.op2Value);
       break;
     case "sub":
       operationResult = sub(currentInstruction.op1Value, currentInstruction.op2Value);
       break;
     case "addi":
       operationResult = add(currentInstruction.op1Value,currentInstruction.op2Value);
       break;
     ...
     case "li":
       ...
       break;     
     case "sll":
       operationResult = sll(currentInstruction.op1Value,currentInstruction.op2Value);
       break;
     case "srl":
       operationResult = srl(currentInstruction.op1Value,currentInstruction.op2Value);
       break;
     case "and":
       operationResult = and(currentInstruction.op1Value,currentInstruction.op2Value);
       break;    
     case "or":
       operationResult = or(currentInstruction.op1Value,currentInstruction.op2Value);
       break;  
     case "nor":
       operationResult = nor(currentInstruction.op1Value,currentInstruction.op2Value);
       break;
     case "beq":
     ...
     case "bne":
       ...
       break;
     case "slt":
       operationResult = slt(currentInstruction.op1Value,currentInstruction.op2Value);
       break; 
     case "slti":
       operationResult = slt(currentInstruction.op1Value,currentInstruction.op2Value);
       break;
